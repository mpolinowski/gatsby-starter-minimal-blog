...
Every MQTT topic you update will now be listed in the ioBroker Object Tree and can be used in every UI / Visualization that you are using:
...
__Unfortunately__ I noticed that ioBroker stopped collecting MQTT topics after a while - and I have no idea why this might be. The Vis UI requires the RAW Topics to connect with our camera and they were still missing. I used the __Plus__ button on to to add these topics manually - which is a bit tedious. If you know how to let ioBroker continue to collect MQTT topics into the object tree please let me know ¯\\_(ツ)_/¯ :
